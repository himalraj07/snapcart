    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-green-50 to-white py-16 px-4 relative">
      ...
      >
        ...
        <form className="flex flex-col gap-6 w-full " onSubmit={handleSubmit}>
            ...
            >
              {" "}
              Grocery Name <span className="text-red-600">*</span>
            </label>
            <input
              type="text"
              id="name"
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            disabled={loading}
            className="mt-4 w-full bg-linear-to-r from-green-500 to-green-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl cursor-pointer disabled:opacity-60 transition-all flex items-center justify-center gap-2"
          >
