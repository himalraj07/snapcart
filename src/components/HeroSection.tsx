...
function HeroSection() {
  ...
  const slides = [
...

    {
      ...
      btnText: "Order Now",
      bg:"https://images.unsplash.com/photo-1683553170878-049f180627b0?q=80&w=1325&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },

    {
      ...
      btnText: "Get Started",
      bg:"https://plus.unsplash.com/premium_photo-1663091378026-7bee6e1c7247?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
  ]
      ...
      <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6'>
        ...
        >
          ...
          <motion.button
            ...
            className='mt-4 bg-white text-green-700 hover:bg-green-100 px-8 py-3 rounded-full font-semibold cursor-pointer shadow-lg transition-all duration-300 flex items-center gap-2'
          >
