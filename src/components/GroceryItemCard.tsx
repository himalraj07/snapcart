  ...
  return (
    ...
    >
      <div className='relative w-full aspect-4/3 bg-gray-50 overflow-hidden group'>
        ...
        <div className='absolute inset-0 bg-linear-to-t from-black/10 cursor-pointer to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300'/>
      </div>
      ...
      <div className='p-4 flex flex-col flex-1'>
        ...
        {!cartItem ? 
          <motion.button
            className='mt-4 flex items-center justify-center cursor-pointer duration-300 gap-2 bg-green-600 hover:bg-green-700 text-white rounded-full py-2 text-sm font-medium transition-all'
            whileTap={{ scale: 0.95 }}
          ...
          >
            <button className='w-7 h-7 flex items-center justify-center cursor-pointer rounded-full bg-green-100 hover:bg-green-200 transition-all'><Minus size={16} className='text-green-700' /></button>
            <span className='text-sm font-semibold text-gray-800'>{cartItem.quantity}</span>
            <button className='w-7 h-7 flex items-center justify-center cursor-pointer rounded-full bg-green-100 hover:bg-green-200 transition-all'><Plus size={16} className='text-green-700' /></button>
          </motion.div>
        }
